...
public class SDCContextBuilderTest {
    ...
    public void testNoAuthHeader() throws Exception {
        ...
        try {
            this.service.getContext(null, fromAppId, transactionId, serviceInstanceId, modelVersionId, modelInvariantId);

        } catch (ToscaCsarException x) {
            assertEquals(Status.BAD_REQUEST, x.getStatus());
            assertTrue(x.getMessage().contains("Authorization"));
        }
    }
    ...
    public void testBadAuthoriztion() throws Exception {
        ...
        try {
            this.service.getContext(authorizationTest, fromAppId, transactionId, serviceInstanceId, modelVersionId, modelInvariantId);
    ...
    public void testNullXFromAppId() throws Exception {
        ...
        try {
            this.service.getContext(authorization, null, transactionId, serviceInstanceId, modelVersionId, modelInvariantId);

        } catch (ToscaCsarException x) {
            assertEquals(Status.BAD_REQUEST, x.getStatus());
            assertTrue(x.getMessage().contains("X-FromAppId"));
        }
    }
    ...
    public void testEmptyXFromAppId() throws Exception {
        ...
        try {
            this.service.getContext(authorization, "", transactionId, serviceInstanceId, modelVersionId, modelInvariantId);
    ...
    public void testNullModelVersionId() throws Exception {
        ...
        try {
            this.service.getContext(authorization, fromAppId, transactionId, serviceInstanceId, null, modelInvariantId);

        } catch (ToscaCsarException x) {
            assertEquals(Status.BAD_REQUEST, x.getStatus());
            assertTrue(x.getMessage().contains("modelVersionId"));
        }
    }
    ...
    public void testEmptyModelVersionId() throws Exception {
        try {
            this.service.getContext(authorization, fromAppId, transactionId, serviceInstanceId, "", modelInvariantId);
